...
function styledstore_welcome_message() {
	...
	<div id="message" class="updated st-message">
		...
		<p><?php printf( esc_html__( 'Thank you for using the Styled Store theme. If you have any problem setting up this theme from scratch you can import demo data with our %sStyled Store Theme Demo Importer Plugin %s ', 'styled-store' ), '<a target="_blank" href="' . esc_url( 'https://wordpress.org/plugins/styled-store-demo-importer/' ) . '">', '</a>' ); ?></p>
	</div>
	<?php
}