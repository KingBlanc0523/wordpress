...
* @fs_premium_only /includes/gateways/beanstream/, /includes/gateways/braintree/, /includes/gateways/netbanx/, /includes/gateways/paymill/, /includes/gateways/paypal-pro/, /includes/gateways/pin/, /includes/gateways/simplify/, /includes/gateways/stripe/, /includes/gateways/authorizenet-aim.php, /includes/gateways/beanstream.php, /includes/gateways/braintree.php, /includes/gateways/ipay88.php, /includes/gateways/komoju.php, /includes/gateways/netbanx.php, /includes/gateways/paygate.php, /includes/gateways/paymill.php, /includes/gateways/paypal-pro.php, /includes/gateways/paypal-standard.php, /includes/gateways/paytabs.php, /includes/gateways/payu-latam.php, /includes/gateways/payumoney.php, /includes/gateways/pin.php, /includes/gateways/simplify.php, /includes/gateways/stripe.php, /includes/gateways/voguepay.php
