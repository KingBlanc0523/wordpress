...
<div id="input_user" style="display:none;">
    <div id="tc_label_widget"  >
        <div class="tc-title-wrap">
            <h4><?php _e('Input Username or Email', 'tcsc'); ?><span id="tc-seat-labels-num"></span></h4>
        </div><!-- .tc-title-wrap -->
        ...
        <div class="tc-options-wrap" >
            ...
            <div class="tc-input-wrap tc-seat-labels" id="tc-labels-multi-select">
                ...
                <div class="tc-input-third-username">
                    <input type="text" class="tc_label_letter" placeholder="Please Input Username or Email" />
                </div><!-- .tc-input-third -->
            </div><!-- .tc-input-wrap -->
            <div class="tc-input-wrap tc-seat-labels" id="tc-labels-single-select">
