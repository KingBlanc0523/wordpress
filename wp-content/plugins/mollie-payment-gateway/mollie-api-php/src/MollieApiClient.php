...
use _PhpScoper5ca3692350464\GuzzleHttp\Client;
use _PhpScoper5ca3692350464\GuzzleHttp\ClientInterface;
use _PhpScoper5ca3692350464\GuzzleHttp\Exception\GuzzleException;
use _PhpScoper5ca3692350464\GuzzleHttp\Psr7\Request;
...
class MollieApiClient
{
     ...
     */
    public function __construct(\_PhpScoper5ca3692350464\GuzzleHttp\ClientInterface $httpClient = null)
    {
        $this->httpClient = $httpClient ? $httpClient : new \_PhpScoper5ca3692350464\GuzzleHttp\Client([\_PhpScoper5ca3692350464\GuzzleHttp\RequestOptions::VERIFY => \_PhpScoper5ca3692350464\Composer\CaBundle\CaBundle::getBundledCaBundlePath(), \_PhpScoper5ca3692350464\GuzzleHttp\RequestOptions::TIMEOUT => self::TIMEOUT]);
        $compatibilityChecker = new \Mollie\Api\CompatibilityChecker();
        $compatibilityChecker->checkCompatibility();
        $this->initializeEndpoints();
        $this->addVersionString("Mollie/" . self::CLIENT_VERSION);
        $this->addVersionString("PHP/" . \phpversion());
        $this->addVersionString("Guzzle/" . \_PhpScoper5ca3692350464\GuzzleHttp\ClientInterface::VERSION);
    }
    ...
    public function performHttpCallToFullUrl($httpMethod, $url, $httpBody = null)
    {
        ...
        $request = new \_PhpScoper5ca3692350464\GuzzleHttp\Psr7\Request($httpMethod, $url, $headers, $httpBody);
        try {
            $response = $this->httpClient->send($request, ['http_errors' => \false]);
        } catch (\_PhpScoper5ca3692350464\GuzzleHttp\Exception\GuzzleException $e) {
     ...
     * @throws ApiException
     */
    private function parseResponseBody(\_PhpScoper5ca3692350464\Psr\Http\Message\ResponseInterface $response)
    {
