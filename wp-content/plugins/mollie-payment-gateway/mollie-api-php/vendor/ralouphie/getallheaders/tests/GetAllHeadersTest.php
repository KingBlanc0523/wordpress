...
namespace _PhpScoper5ca3692350464;

class GetAllHeadersTest extends \_PhpScoper5ca3692350464\PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testWorks($test_type, $expected, $server)
    {
        ...
        $result = \_PhpScoper5ca3692350464\getallheaders();
