...
class StreamWrapper
{
     ...
     */
    public static function getResource(\_PhpScoper5ca3692350464\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\_PhpScoper5ca3692350464\Psr\Http\Message\StreamInterface $stream)
    {
